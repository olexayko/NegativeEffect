...
var bullets_timestamps = [0.25, 0.35, 0.45]
...
func shoot():
	var bullet = load("res://characters/character_classes/rifle_character/attacks/bullet_rifle.tscn").instance()
	...
	bullet.damage = character.get_active_weapon().damage
