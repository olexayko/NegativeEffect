...
var timings = [0.4, 0.1, 0.1, 0.1, 0.5, 0.7]
#var time: float = 0
...
func enter() -> void:
	...
	if MeleeAttackCoords.get_side() == "left":
		...
		print("play AttackLeft" + str(iter))
	...
	if MeleeAttackCoords.get_side() == "right":
		...
		print("play AttackRight" + str(iter))
	...
	if MeleeAttackCoords.get_side() == "down":
		...
		print("play AttackDown" + str(iter))
	...
	if MeleeAttackCoords.get_side() == "up":
		...
		print("play AttackUp" + str(iter))
		
	print("Blunt facing = ", character.facing)
...
func timeout_2():
	...
	break_by_dash = true
	print("break_by_dash = ", break_by_dash)
	step = 2
...
func shoot():	
	...
	"""
	"""
	slash.life_time = timings[1] + timings[2]
